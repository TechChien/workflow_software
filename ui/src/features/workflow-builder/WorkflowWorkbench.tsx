...
type StepRunStatus =
  ...
  | "failed"
  | "stale";
type WorkflowRunStatus = "pending" | "running" | "waiting" | "completed" | "failed" | "cancelled";
...
const sampleSteps: StepDefinition[] = [
  {
    id: "g1_intent_freeze",
...
const initialPublished: PublishedWorkflow[] = [
  {
    id: "version-requirement-analysis-r2",
    revision: 2,
    publishedAt: "2026-06-09 21:20",
    lastRunStatus: "completed",
    workflow: createWorkflowYaml("requirement-analysis-flow", "Requirement Analysis Flow", sampleSteps)
  }
];
